...
function search_popular_deals(){
	...
	var isPresent = 0;
	var searched_query = $("#product").text();
...
function checkLogin(){
	...
	document.getElementById("nav_menu").children[3].style.display="block";
    document.getElementById("nav_menu").children[4].style.display="block";
	document.getElementById("nav_menu").children[5].style.display="block";
	document.getElementById("nav_menu").children[6].style.display="none";
    document.getElementById("nav_menu").children[7].style.display="none";
	...
	document.getElementById("nav_menu").children[3].style.display="none";
    document.getElementById("nav_menu").children[4].style.display="none";
	document.getElementById("nav_menu").children[6].style.display="block";
    document.getElementById("nav_menu").children[7].style.display="block";
	}
}

function checkLoginSecendary(){
	...
	document.getElementById("nav_menu").children[0].style.display="block";
	document.getElementById("nav_menu").children[1].style.display="none";
	document.getElementById("nav_menu").children[2].style.display="none";
	document.getElementById("nav_menu").children[3].style.display="block";
    document.getElementById("nav_menu").children[4].style.display="block";
    document.getElementById("nav_menu").children[5].style.display="none";
